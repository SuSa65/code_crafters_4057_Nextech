...
.social-login__icon:hover {
  ...
  <body style="Background-image:url('https://www.unstudio.com/image/2023/1/25/evabloem_unstudio_echo_exterior_007-238455128.jpg%28mediaclass-background-xl.07f7adb8a95599dcb70557da25aa6351c3fd0c58%29.jpg');background-repeat:no-repeat;background-size:cover;">
    <h1 style="text-align:center;">Student LOGIN HERE</h1><br>
<div class="container">
	<div class="screen">
		<div class="screen__content">
			<form class="login" action="c_login.php" method="post">
				<div class="login__field">
					...
					<input type="text" class="login__input" placeholder="Number" name="stu_rollno" id="username" required>
				</div>
                <div class="login__field">
					<i class="login__icon fas fa-user"></i>
					<input type="password" class="login__input" placeholder="password" name="stu_password" id="password" required>
				</div>
