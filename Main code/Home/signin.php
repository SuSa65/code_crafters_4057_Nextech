	...
	<div class="screen">
		<div class="screen__content">
			<form class="signup" action="signsql.php" method="post">
                ...
                <div class="login__field">
					<i class="login__icon fas fa-user"></i>
					<input name="stu_address" type="text" class="login__input" placeholder="Address" required>
				</div>
                <div class="login__field">
					<i class="login__icon fas fa-user"></i>
                ...
                <div class="login__field">
					<i class="login__icon fas fa-user"></i>
					<input type="password" name="stu_password" id="stu_password" type="password" class="login__input" placeholder="password">
                    <span id="pd" style="color:red;"><span>
				</div>
                <div class="login__field">
					<i class="login__icon fas fa-user"></i>
					<input type="password" class="login__input" id="stuc_password" placeholder="confirm password" required>
                    <span id="cp"><span>
				</div>
...
$(document).ready(function () {
  ...
  $("#stuc_password").on('keyup', function(){
    var password = $("#stu_Password").val();
    var confirmPassword = $("#stuc_password").val();
